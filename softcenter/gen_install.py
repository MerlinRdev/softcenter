...
def work_parent():
    ignore_paths = frozenset(["maintain_files", "softcenter", "rules", "v2ray_binary", "speedup", "speedtest", "bxc", "bypasshelper", "uu", "dc1svr", "shadowsocks", "v2ray", "ssserver", "fanyou", "syncthing"])
