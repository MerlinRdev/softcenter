								...
								<tr>
									<td bgcolor="#4D595D" colspan="3" valign="top">
										...
										<div style="padding-top:5px;margin-top:0px;float: left;" id="NoteBox" >
											...
											<li>注意离线安装包对应的cpu架构，上传错误的安装包会无法运行； </li>
										</div>
                                    	...
                                    	<div id="log_content" style="margin-top:10px;display: block;">
											<textarea cols="63" rows="15" wrap="off" readonly="readonly" id="log_content1" style="width:99%; font-family:'Lucida Console'; font-size:12px;background:transparent;border:1px solid #91071f;color:#FFFFFF;"></textarea>
										</div>
