...
[ ! -e "/jffs/softcenter/init.d/M99v2ray.sh" ] && cp -r /jffs/softcenter/scripts/v2ray_config.sh /jffs/softcenter/init.d/M99v2ray.sh
[ ! -e "/jffs/softcenter/init.d/N99v2ray.sh" ] && cp -r /jffs/softcenter/scripts/v2ray_config.sh /jffs/softcenter/init.d/N99v2ray.sh
exit 0
}
restart_v2ray() {
	stop_v2ray
