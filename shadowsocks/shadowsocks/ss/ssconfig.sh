...
apply_ss(){
	...
	sh /jffs/softcenter/scripts/ss_prestart.sh
	sh /jffs/softcenter/ss/start.sh start_all
	# if [ "1" == "$ss_basic_action" ]; then
	# 	sh /jffs/softcenter/ss/stop.sh stop_part
	# 	sh /jffs/softcenter/scripts/ss_prestart.sh
	# 	sh /jffs/softcenter/ss/start.sh start_all
	# elif [ "2" == "$ss_basic_action" ]; then
	# 	sh /jffs/softcenter/ss/start.sh restart_dns
	# elif [ "3" == "$ss_basic_action" ]; then
	# 	sh /jffs/softcenter/ss/start.sh restart_wb_list
	# elif [ "4" == "$ss_basic_action" ]; then
	# 	sh /jffs/softcenter/ss/start.sh restart_addon
	# fi
